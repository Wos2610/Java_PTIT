...
public class J07036 {
    ...
    static class BangDiem {
        ...
        public String toString() {
            return sinhVien.ma + " " + sinhVien.ten + " " + monHoc.ma + " " + monHoc.ten + " " + NumberFormat.getInstance().format(diem);
        }
    }
    ...
    static void nhapBangDiem(List<MonHoc> m, List<SinhVien> s, List<BangDiem> b) throws FileNotFoundException {
        ...
        Collections.sort(b, new Comparator<BangDiem>() {
            ...
            public int compare(BangDiem o1, BangDiem o2) {
                if(o1.monHoc.ma.equals(o2.monHoc.ma)){
                    return o1.sinhVien.ma.compareTo(o2.sinhVien.ma);
                }
                return o1.monHoc.ma.compareTo(o2.monHoc.ma);
            }
        });
        ...
        for(int i = 1; i <= a; i++){
            ...
            System.out.println("BANG DIEM lop " + x + ":");
            for(int j = 0; j < n; j++){
                if(b.get(j).sinhVien.lop.equals(x)){
