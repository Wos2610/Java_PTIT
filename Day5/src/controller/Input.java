...
public class Input {
    ...
    public Client inputClient() throws InvalidInfoException{
    ...
    public Room inputRoomSwing(String roomName, String roomType){
        return new Room(roomName, roomType);
    }
    
    public void inputRoomList(ArrayList<Client> clients, ArrayList<Room> rooms) throws InvalidInfoException{
        ...
        Process.bookRoom(roomID, rooms, clientID, clients, rentTime);
    }
}
